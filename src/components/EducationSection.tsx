              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-grow text-left">
                  ...
                  <p className="text-gray-300">
                    Currently in my second year of studies, focusing on building a strong foundation in programming, algorithms, and software engineering principles.
                  </p>
                  <div className="mt-6">
                ...
                <div className="flex-grow text-left">
                  ...
                  <div className="mt-4">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
                      ...
                      <li className="flex items-center text-gray-300">
                        <span className="w-2 h-2 bg-lilac rounded-full mr-2"></span>
                        Glitch Hunt Winner - FDCI Club
                      </li>
                      <li className="flex items-center text-gray-300">
                        <span className="w-2 h-2 bg-lilac rounded-full mr-2"></span>
                        Google Solutions Challenge Participant
                      </li>
                      <li className="flex items-center text-gray-300">
                        <span className="w-2 h-2 bg-lilac rounded-full mr-2"></span>
