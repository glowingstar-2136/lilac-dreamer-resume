              ...
              <AnimatedCard className="p-8 h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start text-left">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mt-1">Available weekdays 9 AM - 5 PM</p>
                    </div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 bg-lilac/20 rounded-full flex items-center justify-center hover:bg-lilac/40 transition-colors">
